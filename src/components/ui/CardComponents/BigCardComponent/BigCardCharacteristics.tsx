//BigCardCharacteristics.tsx

interface BigCardCharacteristicsProps {
    abilities: Array<{
      ability: {
        name: string;
      };
  ...
  const BigCardCharacteristics: React.FC<BigCardCharacteristicsProps> = ({
    abilities,
    height,
    image,
    weight,
    ...
    return (
      <div className="container flex flex-col items-center justify-start xl:flex-row">
        <img src={image} alt="Pokemon" className="max-h-40 xl:max-h-64" />
